<html>
    ...
    <div id="main"><!-- **Breadcrumb** --><section class="breadcrumb-section">	<div class="container"><div class="breadcrumb">				
                    ...
                    <span class='fa fa-angle-double-right' >  </span><h6>Dress Designing</h6></div>
            ...
            <section id="primary" class="content-full-width">
                ...
                <div class="side-navigation">
                    <div class="side-nav-container">
                        <ul class="side-nav">
                            ...
                            <li class='current_page_item'><a href="<?php echo site_url("treatments/dressdesign"); ?>" title='Dress Designing'>Dress Designing</a></li>
                ...
                <div class="side-navigation-content">               
                    ...
                    <div id="post-2125" class="post-2125 page type-page status-publish hentry">
                        <h2>Head Dresses</h2>
                        <img class="aligncenter size-full wp-image-234" src="<?php echo site_url("uploads/bridal/dressdesign.jpg"); ?>" alt="image" width="680" height="452" /><br />
                        <div class="dt-sc-titled-box  " ><h6 class="dt-sc-titled-box-title">Description</h6>
                            <div class="dt-sc-titled-box-content">
                                <p> Looking for something a little different? Our Bridal Designer can customize designs for you.  Contact us for details.<br/>

                                    Our beautiful designer wedding dresses are amongst the most stunning and intricate available on the market, and 
                                    you'll be hard pressed to find better wedding dresses anywhere in Sri Lanka.</p>
