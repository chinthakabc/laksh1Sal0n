<html>
    ...
    <div id="main"><!-- **Breadcrumb** --><section class="breadcrumb-section">	<div class="container"><div class="breadcrumb">				
                    <a href="<?php echo site_url('home/') ?>">Home</a><span class='fa fa-angle-double-right' >  </span><a href="<?php echo site_url("treatments/facial_treatments/1"); ?>">Facial Treatments</a>
                ...
                <div class="side-navigation">
                    <div class="side-nav-container">
                        <ul class="side-nav">
                            ...
                            <li class="<?php echo $curr_page==$p['id']?"current_page_item":"";?>"><a href="<?php echo site_url("treatments/facial_treatments/".$p['id']); ?>" title="<?php echo $p['title'];?>"><?php echo $p['title'];?></a></li>
<!--                            <li class=''><a href="<?php //echo site_url("treatments/bouquets"); ?>" title='Bouquets'>Bouquets</a></li>
                ...
                <div class="side-navigation-content">               
                    ...
                    <div id="post-2125" class="post-2125 page type-page status-publish hentry">
                        ...
                        <img class="aligncenter size-full wp-image-234" src="<?php echo site_url("uploads/facial_treatments/".$r['image_url']); ?>" alt="image" width="680" height="452" /><br />
