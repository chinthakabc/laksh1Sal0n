        ...
        <div class="container">
            ...
            <section id="primary" class="content-full-width">
                ...
                <div id="post-247" class="post-247 page type-page status-publish hentry">
                    <div  class='column dt-sc-two-third  first'><h3>Apply For The Vacancy</h3>
                        <div class="wpcf7" id="wpcf7-f4088-p247-o1" lang="en-US" dir="ltr">
                            <div class="screen-reader-response"></div>
                            <form name="" action="<?php echo site_url("appointment_controller/do_career");?>" method="post" class="wpcf7-form" novalidate="novalidate">
                                ...
                                <p class="column dt-sc-one-column">
                                    <span class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required">
                                        <input type="text" name="your-fname" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Address (reduired)" />
                                    </span>
                                </p>
                                <div class="clear"> </div>
                                <div class="hr-invisible-very-small"> </div>
                                <div class="column dt-sc-one-half first">
                                    <span class="wpcf7-form-control-wrap birth-date">
                                        <input type="date" name="mobite" value="" class="wpcf7-form-control wpcf7-date wpcf7-validates-as-required wpcf7-validates-as-date" aria-required="true" aria-invalid="false" placeholder="Mobile (required)" />
                                    </span>
                                </div>
                                ...
                                <p><br>
                                    <span class="wpcf7-form-control-wrap your-message">
                                        <textarea name="qualification" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Qualification (required)"></textarea>
                                    </span>
                                </p>
                                <div class="clear"> </div>
                                <div class="hr-invisible-very-small"> </div>
